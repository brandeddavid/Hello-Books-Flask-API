...
from api.users.views import GetAllUsers, BorrowOps, BorrowHistory, GetUser
...
api.add_resource(BorrowOps, '/api/v1/users/books/<book_id>')
api.add_resource(BorrowHistory, '/api/v1/users/books')
